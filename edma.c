...
uint8_t edma_Init() {
    ...
    CT_TCC.TCC_ECR |= (1 << EDMA3CC_ECAP0_EVT); // clear evento ecap0
    CT_TCC.TCC_IECR |= (1 << EDMA3CC_ECAP0_EVT); // clear interrupt ecap0
    CT_TCC.TCC_SECR |= (1 << EDMA3CC_ECAP0_EVT); // clear secondary event ecap0
    CT_TCC.TCC_ICR |= (1 << EDMA3CC_ECAP0_EVT); // clear interrupt ecap0
    CT_TCC.TCC_EMCR |= (1 << EDMA3CC_ECAP0_EVT); // clear event missing ecap0

    CT_TCC.TCC_EESR = (1 << EDMA3CC_ECAP0_EVT); // abilito evento ecap0
    CT_TCC.TCC_IESR = (1 << EDMA3CC_ECAP0_EVT); // abilito interrupt ecap0
